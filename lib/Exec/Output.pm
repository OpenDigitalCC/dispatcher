...
#
# Args:
#   $results  - arrayref of result hashrefs from Exec::Engine::dispatch_all
#
# Each result hashref:
...
#
# Args:
#   $results  - arrayref of result hashrefs from Exec::Engine::ping_all
#
# Each result hashref:
...
#
# Args:
#   $agents  - arrayref of agent hashrefs from Exec::Registry::list_agents
#
# Each agent hashref:
