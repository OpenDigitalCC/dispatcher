...
# t/header-limit.t
#
# Tests for the HTTP header count limit (431) in bin/ctrl-exec-agent.
#
# SKIPPED: ctrl-exec-agent calls main() unconditionally at the top level
...
# (e.g. Exec::Agent::HTTP) to allow unit testing here.
...
plan skip_all =>
    'ctrl-exec-agent cannot be loaded via do() '
